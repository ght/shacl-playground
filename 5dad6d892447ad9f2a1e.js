(window.webpackJsonp=window.webpackJsonp||[]).push([[15],{181:function(e,t){},182:function(e,t){},206:function(e,t){},208:function(e,t){},209:function(e,t){},216:function(e,t){},414:function(e,t,i){"use strict";i.r(t);var s=i(10),r=(i(176),i(78)),a=i(44),o=(i(244),i(392),i(171)),d=i(155);i(245),i(226),i(227);class l extends s.b{static get styles(){return s.c`
      :host {
        display: block;
      }
    ...
    `}static get properties(){return{format:{type:String},graph:{type:String},model:{type:String},prefixes:{type:Array},customPrefixes:{type:Object}}}async firstUpdated(){const e=this.shadowRoot.querySelector("rdf-editor");await e.ready,await(m||(m=new Promise(e=>{const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.32.0/addon/display/autorefresh.min.js",t.onload=e,document.head.appendChild(t)})),m),e.codeMirror.editor.setOption("autoRefresh",!0)}render(){return s.d`
      ...
      ></rdf-editor>
    `}__forwardEvent(e){this.dispatchEvent(new Event(e.type))}__quadsChanged(e){a.a.dispatch[this.model].parsed({quads:e.detail.value,serialized:e.target.codeMirror.value})}mapState(e){return{format:e[this.model].format,prefixes:e[this.model].prefixes,customPrefixes:e[this.model].customPrefixes||{},graph:e[this.model].graph}}}customElements.define("graph-editor",f)}}]);
//# sourceMappingURL=5dad6d892447ad9f2a1e.js.map